...
if not df_recent.empty:
    ...
    fig.update_layout(
        ...
        xaxis=dict(title=dict(text="Date",font=dict(color='#FFFFFF')), showgrid=False, color='#FFFFFF', tickformat="%d-%b\n%H:%M", dtick=43200000),
        yaxis=dict(title=dict(text=" Predicted AQI",font=dict(color='#FFFFFF')), showgrid=True, gridcolor='#334155', color='#FFFFFF', range=[0.5, 5.5],
                   )
    )
